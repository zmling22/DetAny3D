...
with open('/cpfs01/user/zhanghanxue/omni3d/datasets/Omni3D/KITTI_test.json', 'rb') as f:
    dataset_json = json.load(f)

with open('/cpfs01/user/zhanghanxue/segment-anything/data/kitti/kitti_data_val_detany3d_no_occlusion_v3.pkl', 'rb') as f:
...
for anno in dataset_json['annotations']:
    ...
    # instance_dict = {}
    # visibility = dataset_json['annotations']['visibility']
    # truncation = dataset_json['annotations']['truncation']
    # instance_dict['visibility'] = visibility
    # instance_dict['truncation'] = truncation
...
for key in image_dict.keys():
    ...
    img_key = '/cpfs01/shared/opendrivelab/anydet3d/data/kitti/training/image_2/' + img_path.split('/')[-1]
