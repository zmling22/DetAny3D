...
def process_obj_list(path_instance):
    ...
    img_path = './data/ARKitScenes/datasets/' + path
    # print(img_path)
...
output_pkl = './data/pkls/ARKitScenes_test_detany3d.pkl'
omni3d_json_path = '/cpfs01/user/zhanghanxue/omni3d/datasets/Omni3D/ARKitScenes_test.json'
