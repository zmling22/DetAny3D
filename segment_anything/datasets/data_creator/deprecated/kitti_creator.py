...
def process_data(output_pkl, anydet3dpkl = None, omni3d_json_path = None):
    ...
    for instance in origin_dataset_pkl:
        ...
        # import ipdb;ipdb.set_trace()
        omni3d_key = 'KITTI_object' + instance['img_path'].split('kitti')[-1]
...
output_pkl = '/cpfs01/shared/opendrivelab/zhanghanxue/DetAny3D/data/kitti/kitti_data_train_detany3d_according_to_omni3d_with_edge_obj.pkl'
anydet3dpkl = '/cpfs01/user/zhanghanxue/segment-anything/data/kitti/kitti_data_train_detany3d_no_occlusion_v3.pkl'
omni3d_json_path = '/cpfs01/user/zhanghanxue/omni3d/datasets/Omni3D/KITTI_train.json'
