...
from .depth_and_camera_aware_transformer import DepthAndCameraAwareTransformer
...
class MaskDecoderV2(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.depth_and_camera_aware_transformer = DepthAndCameraAwareTransformer(\
            depth=2,
            embedding_dim=cfg.model.image_encoder.out_chans,
            mlp_dim=2048,
            num_heads=8,
            inject_layer=1,)
    ...
    def predict_masks(
        ...
        hs, src = self.depth_and_camera_aware_transformer(src, pos_src, metric_embeddings, camera_embeddings, depth_embeddings, tokens)
